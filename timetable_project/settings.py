...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-dev-key-for-timetable-system')
...
MONGODB_SETTINGS = {
    'host': config('MONGODB_URI', default='mongodb://localhost:27017/TIMETABLE'),
    'db': 'TIMETABLE',
}
...
TEAM_INFO = {
    ...
    'team_members': ['SANJAY B', 'YASWANTH ST', 'ABISHECK AM'],
